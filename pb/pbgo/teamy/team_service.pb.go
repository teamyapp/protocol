...
var file_teamy_team_service_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79,
	0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
...
var file_teamy_team_service_proto_goTypes = []any{
...
func file_teamy_team_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teamy_team_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_teamy_team_service_proto_msgTypes[16].Exporter = func(v any, i int) any {
	...
	file_teamy_team_service_proto_msgTypes[6].OneofWrappers = []any{}
	file_teamy_team_service_proto_msgTypes[9].OneofWrappers = []any{}
	type x struct{}
