...
const (
	...
	StoryService_GetTasksByStory_FullMethodName      = "/StoryService/GetTasksByStory"
...
type StoryServiceClient interface {
	...
	GetTasksByStory(ctx context.Context, in *GetTasksByStoryRequest, opts ...grpc.CallOption) (*GetTasksByStoryResponse, error)
...
func (c *storyServiceClient) GetTasksByStory(ctx context.Context, in *GetTasksByStoryRequest, opts ...grpc.CallOption) (*GetTasksByStoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTasksByStoryResponse)
	err := c.cc.Invoke(ctx, StoryService_GetTasksByStory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storyServiceClient) UpdateStory(ctx context.Context, in *UpdateStoryRequest, opts ...grpc.CallOption) (*UpdateStoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, StoryService_UpdateStory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storyServiceClient) AddTaskToStory(ctx context.Context, in *AddTaskToStoryRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, StoryService_AddTaskToStory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storyServiceClient) RemoveTaskFromStory(ctx context.Context, in *RemoveTaskFromStoryRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, StoryService_RemoveTaskFromStory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storyServiceClient) AddTasksToStory(ctx context.Context, in *AddTasksToStoryRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, StoryService_AddTasksToStory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storyServiceClient) RemoveTasksFromStory(ctx context.Context, in *RemoveTasksFromStoryRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, StoryService_RemoveTasksFromStory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StoryServiceServer interface {
	...
	GetTasksByStory(context.Context, *GetTasksByStoryRequest) (*GetTasksByStoryResponse, error)
...
func (UnimplementedStoryServiceServer) GetTasksByStory(context.Context, *GetTasksByStoryRequest) (*GetTasksByStoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTasksByStory not implemented")
}
...
func _StoryService_GetTasksByStory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTasksByStoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StoryServiceServer).GetTasksByStory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StoryService_GetTasksByStory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StoryServiceServer).GetTasksByStory(ctx, req.(*GetTasksByStoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTasksByStory",
			Handler:    _StoryService_GetTasksByStory_Handler,
		},
		{
