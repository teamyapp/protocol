...
const (
	GroupType_GROUP_TYPE_STATIC GroupType = 0
	GroupType_GROUP_TYPE_FILTER GroupType = 1
)
...
const (
	GroupMemberType_GROUP_MEMBER_TYPE_USER GroupMemberType = 0
	GroupMemberType_GROUP_MEMBER_TYPE_TEAM GroupMemberType = 1
)

// Enum value maps for GroupMemberType.
var (
	GroupMemberType_name = map[int32]string{
		0: "GROUP_MEMBER_TYPE_USER",
		1: "GROUP_MEMBER_TYPE_TEAM",
	}
...
func (x *GroupBase) GetType() GroupType {
	...
	return GroupType_GROUP_TYPE_STATIC
}
...
func (x *GroupBase) GetMemberType() GroupMemberType {
	...
	return GroupMemberType_GROUP_MEMBER_TYPE_USER
}
...
type Group struct {
	...
	//
	//	*Group_UserStaticGroup
	//	*Group_TeamStaticGroup
	//	*Group_FilterGroup
	Group isGroup_Group `protobuf_oneof:"group"`
}
...
func (m *Group) GetGroup() isGroup_Group {
	if m != nil {
		return m.Group
	}
	return nil
...
func (x *Group) GetUserStaticGroup() *UserStaticGroup {
	if x, ok := x.GetGroup().(*Group_UserStaticGroup); ok {
...
func (x *Group) GetTeamStaticGroup() *TeamStaticGroup {
	if x, ok := x.GetGroup().(*Group_TeamStaticGroup); ok {
...
func (x *Group) GetFilterGroup() *FilterGroup {
	if x, ok := x.GetGroup().(*Group_FilterGroup); ok {
		return x.FilterGroup
	}
	return nil
}

type isGroup_Group interface {
	isGroup_Group()
}

type Group_UserStaticGroup struct {
	UserStaticGroup *UserStaticGroup `protobuf:"bytes,1,opt,name=userStaticGroup,proto3,oneof"`
}

type Group_TeamStaticGroup struct {
	TeamStaticGroup *TeamStaticGroup `protobuf:"bytes,2,opt,name=teamStaticGroup,proto3,oneof"`
}

type Group_FilterGroup struct {
	FilterGroup *FilterGroup `protobuf:"bytes,3,opt,name=filterGroup,proto3,oneof"`
}

func (*Group_UserStaticGroup) isGroup_Group() {}

func (*Group_TeamStaticGroup) isGroup_Group() {}

func (*Group_FilterGroup) isGroup_Group() {}
...
var file_teamy_message_group_proto_rawDesc = []byte{
	...
	,
...
var file_teamy_message_group_proto_depIdxs = []int32{
	...
	4,  // 8: Group.userStaticGroup:type_name -> UserStaticGroup
	5,  // 9: Group.teamStaticGroup:type_name -> TeamStaticGroup
	6,  // 10: Group.filterGroup:type_name -> FilterGroup
...
func file_teamy_message_group_proto_init() {
	...
	file_teamy_message_group_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*Group_UserStaticGroup)(nil),
		(*Group_TeamStaticGroup)(nil),
		(*Group_FilterGroup)(nil),
	}
	type x struct{}
