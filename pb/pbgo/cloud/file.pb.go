...
var file_cloud_file_proto_goTypes = []any{
...
func file_cloud_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cloud_file_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_cloud_file_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_cloud_file_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	file_cloud_file_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
