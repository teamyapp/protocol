...
import { Priority } from "./message/common";
...
export interface ListStoriesRequest {
    /**
     * @generated from protobuf field: repeated uint64 storyIds = 1;
     */
    storyIds: number[];
}
/**
...
export interface CreateStoryRequest {
    ...
    name: string;
    /**
     * @generated from protobuf field: uint64 ownerUserId = 3;
     */
    ownerUserId: number;
    /**
     * @generated from protobuf field: Priority priority = 4;
     */
    priority: Priority;
    /**
...
class ListStoriesRequest$Type extends MessageType<ListStoriesRequest> {
    constructor() {
        super("ListStoriesRequest", [
            { no: 1, name: "storyIds", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListStoriesRequest): ListStoriesRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated uint64 storyIds */ 1:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string name */ 2:
                    ...
                    break;
                case /* uint64 ownerUserId */ 3:
                    message.ownerUserId = reader.uint64().toNumber();
                    break;
                case /* Priority priority */ 4:
