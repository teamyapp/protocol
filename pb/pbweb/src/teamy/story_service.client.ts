...
import type { GetTasksByStoryResponse } from "./story_service";
import type { GetTasksByStoryRequest } from "./story_service";
...
export interface IStoryServiceClient {
    ...
    /**
     * @generated from protobuf rpc: GetTasksByStory(GetTasksByStoryRequest) returns (GetTasksByStoryResponse);
     */
    getTasksByStory(input: GetTasksByStoryRequest, options?: RpcOptions): UnaryCall<GetTasksByStoryRequest, GetTasksByStoryResponse>;
    /**
...
export class StoryServiceClient implements IStoryServiceClient, ServiceInfo {
    ...
    getTasksByStory(input: GetTasksByStoryRequest, options?: RpcOptions): UnaryCall<GetTasksByStoryRequest, GetTasksByStoryResponse> {
        ...
        return stackIntercept<GetTasksByStoryRequest, GetTasksByStoryResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * @generated from protobuf rpc: CreateStory(CreateStoryRequest) returns (CreateStoryResponse);
     */
