...
export interface Phase {
    ...
    /**
     * @generated from protobuf field: uint64 creatorUserId = 8;
     */
...
export enum PhaseStatus {
    /**
     * @generated from protobuf enum value: PHASE_TODO = 0;
     */
    PHASE_TODO = 0,
    /**
     * @generated from protobuf enum value: PHASE_IN_PROGRESS = 1;
     */
    PHASE_IN_PROGRESS = 1,
    /**
     * @generated from protobuf enum value: PHASE_PAUSED = 2;
     */
    PHASE_PAUSED = 2,
    /**
     * @generated from protobuf enum value: PHASE_COMPLETED = 3;
     */
    PHASE_COMPLETED = 3
}
...
class Phase$Type extends MessageType<Phase> {
    constructor() {
        super("Phase", [
            ...
            { no: 8, name: "creatorUserId", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
    ...
    internalBinaryWrite(message: Phase, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint64 creatorUserId = 8; */
        if (message.creatorUserId !== 0)
            writer.tag(8, WireType.Varint).uint64(message.creatorUserId);
