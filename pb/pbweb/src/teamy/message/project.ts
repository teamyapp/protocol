...
export interface Project {
    ...
    color?: string;
    /**
     * @generated from protobuf field: int32 total_phase_count = 13;
     */
    totalPhaseCount: number;
    /**
     * @generated from protobuf field: int32 completed_phase_count = 14;
     */
...
class Project$Type extends MessageType<Project> {
    constructor() {
        super("Project", [
            ...
            { no: 13, name: "total_phase_count", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 14, name: "completed_phase_count", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<Project>): Project {
        ...
        message.teamId = 0;
        message.totalPhaseCount = 0;
        message.completedPhaseCount = 0;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional string color */ 12:
                    ...
                    break;
                case /* int32 total_phase_count */ 13:
                    message.totalPhaseCount = reader.int32();
                    break;
                case /* int32 completed_phase_count */ 14:
                    message.completedPhaseCount = reader.int32();
                    break;
                default:
    ...
    internalBinaryWrite(message: Project, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int32 total_phase_count = 13; */
        if (message.totalPhaseCount !== 0)
            writer.tag(13, WireType.Varint).int32(message.totalPhaseCount);
        /* int32 completed_phase_count = 14; */
        if (message.completedPhaseCount !== 0)
            writer.tag(14, WireType.Varint).int32(message.completedPhaseCount);
