...
/**
 * @generated from protobuf message GetMessageRequest
 */
...
export interface ListMessagesRequest {
    /**
     * @generated from protobuf field: repeated uint64 messageIds = 1;
     */
    messageIds: number[];
    /**
...
/**
 * @generated MessageType for protobuf message GetMessageRequest
 */
...
/**
 * @generated MessageType for protobuf message GetMessageResponse
 */
...
class ListMessagesRequest$Type extends MessageType<ListMessagesRequest> {
    constructor() {
        super("ListMessagesRequest", [
            { no: 1, name: "messageIds", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListMessagesRequest): ListMessagesRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated uint64 messageIds */ 1:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.messageIds.push(reader.uint64().toNumber());
                    else
                        message.messageIds.push(reader.uint64().toNumber());
                    break;
...
/**
 * @generated ServiceType for protobuf service MessageService
 */
export const MessageService = new ServiceType("MessageService", [
